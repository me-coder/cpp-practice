...
#ifdef _WIN32
#ifdef CSTRINGHANDLER_EXPORTS // Defined when building the DLL
#define ExportedByCStringHandler __declspec(dllexport)
#else // Defined when using the DLL
#define ExportedByCStringHandler __declspec(dllimport)
#endif
#else // not Windows
#define ExportedByCStringHandler
#endif
...
class ExportedByCStringHandler CStringHandler
{
public:
    /**
     * Default constructor.
